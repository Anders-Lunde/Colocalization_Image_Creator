 ...
 * @version 1.0, 7/11/07
 * 
 * Modified by Anders Lunde to supress batch processing errors when no objects are found
 * Modified lines marked with #MODIEFIED BY LUNDE
 */
public class Counter3D {
    ...
    boolean sizeFilter=true, exclude=false, redirect=false, closeImg=false, showMaskedImg=false; //#MODIEFIED BY LUNDE
    Vector<Object3D> obj;
    ...
    private void findObjects() {
        ...
        //IJ.log("Total detected 3d objects: " + String.valueOf(nDetectedObjects)); //#MODIEFIED BY LUNDE
        //IJ.log("Removed 3d objects: " + String.valueOf(nFilteredObjects)); //#MODIEFIED BY LUNDE
        ...
        //IJ.log("Total 3D objects before filtering: " + String.valueOf(IDcount.length - nFilteredObjects + nbObj)); //#MODIEFIED BY LUNDE
        //IJ.log("IDcount.length " + String.valueOf(IDcount.length)); //#MODIEFIED BY LUNDE
        //IJ.log("newCurrID " + String.valueOf(newCurrID)); //#MODIEFIED BY LUNDE
        //IJ.log("nFilteredObjects " + String.valueOf(nFilteredObjects)); //#MODIEFIED BY LUNDE
        //IJ.log(" " + String.valueOf(IDcount.length)); //#MODIEFIED BY LUNDE
        IJ.log("Total 3D objects after filtering:  " + String.valueOf(nbObj)); //#MODIEFIED BY LUNDE
        foundObjects=true;
    }
    ...
    private void imgArrayModifier(ImagePlus img){
        ...
        if (nbObj<=0){
            IJ.log("No object found"); //#MODIEFIED BY LUNDE
            return;
        }
    }
